module github.com/grokify/aha-studio
...
require (
	...
	github.com/grokify/omniroadmap-core v0.0.0
...
// TEMPORARY: aha-go rate-limiting changes (WithRequestsPerSecond, retry) are
// implemented locally but not yet tagged/released. Remove before pushing;
// see RMI-AHASTUDIO-005 for the precedent of removing this before push.
replace github.com/grokify/aha-go => ../aha-go

replace github.com/grokify/omniroadmap-core => ../omniroadmap-core

...
type Feature struct {
	...
	// ReleaseReferenceNum holds the value of the "release_reference_num" field.
...
func (*Feature) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case feature.FieldData:
			values[i] = new([]byte)
		case feature.FieldID, feature.FieldProduct, feature.FieldReferenceNum, feature.FieldName, feature.FieldDescription, feature.FieldStatus, feature.FieldAssignedTo, feature.FieldStartDate, feature.FieldDueDate, feature.FieldRelease, feature.FieldReleaseID, feature.FieldReleaseReferenceNum, feature.FieldTags, feature.FieldURL:
...
func (_m *Feature) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case feature.FieldReleaseReferenceNum:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field release_reference_num", values[i])
			} else if value.Valid {
				_m.ReleaseReferenceNum = value.String
			}
...
func (_m *Feature) String() string {
	...
	builder.WriteString(_m.DueDate)
	builder.WriteString(", ")
	...
	builder.WriteString(", ")
	builder.WriteString("release_reference_num=")
	builder.WriteString(_m.ReleaseReferenceNum)
	builder.WriteString(", ")

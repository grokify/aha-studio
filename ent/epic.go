...
func (*Epic) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case epic.FieldID, epic.FieldProduct, epic.FieldReferenceNum, epic.FieldName, epic.FieldDescription, epic.FieldStatus, epic.FieldStartDate, epic.FieldDueDate, epic.FieldRelease, epic.FieldURL:
			values[i] = new(sql.NullString)
		case epic.FieldCreatedAt, epic.FieldUpdatedAt:

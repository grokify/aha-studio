...
func (*Idea) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case idea.FieldID, idea.FieldProduct, idea.FieldReferenceNum, idea.FieldName, idea.FieldDescription, idea.FieldStatus, idea.FieldTags, idea.FieldURL:
...
// to the Idea fields.
func (_m *Idea) assignValues(columns []string, values []any) error {
...
func (_m *Idea) Value(name string) (ent.Value, error) {
